  ...
  btns.forEach(function (btn) {
    btn.addEventListener('click', function () {
      ...
      if (this.classList.contains('active-style')) {
        ...
        //scrollHeight высота контента которые содержится внутри елемента + 80px padding
...
var drop = function drop() {
  ...
  fileInputs.forEach(function (input) {
    input.addEventListener('drop', function (e) {
      ...
      var dots;
      var arr = input.files[0].name.split('.'); // 'dsfsdfsdfsdf.jpg' => ['dsfsdfsdfsdf', 'jpg']
...
var forms = function forms() {
  ...
  upload.forEach(function (item) {
    item.addEventListener('input', function () {
      var dots;
      var arr = item.files[0].name.split('.'); // 'dsfsdfsdfsdf.jpg' => ['dsfsdfsdfsdf', 'jpg']
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      statusMessage.appendChild(textMessage); ///////////////////Form Data///////////////////////////
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        btnPressed = true; //проверяем была ли нажата какая-то кнопка
    ...
    setTimeout(function () {
      ...
      document.querySelectorAll('[data-modal]').forEach(function (item) {
        if (getComputedStyle(item).display !== 'none') {
          //проверяем на другие модальные окна    
          display = 'block';
        }
      });
...
var pictureSize = function pictureSize(imgSelector) {
  ...
  function showImg(block) {
    ...
    block.querySelectorAll('p:not(.sizes-hit)').forEach(function (p) {
      //p:not(.sizes-hit)не будет скрывать параграфф
...
var scrolling = function scrolling(upSelector) {
  ...
  //         if (this.hash !== '') {
  //             e.preventDefault();        //.getElementById(this.hash.substring(1)),
